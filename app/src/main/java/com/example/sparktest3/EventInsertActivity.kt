...
//import java.util.*
//
//class EventInsertActivity : AppCompatActivity() {
//
...
//                uri?.let { processImage(it) } ?: Toast.makeText(this, "No image selected", Toast.LENGTH_SHORT).show()
//            } else {
...
//        insertButton.setOnClickListener { insertEvent() }
//    }
//
